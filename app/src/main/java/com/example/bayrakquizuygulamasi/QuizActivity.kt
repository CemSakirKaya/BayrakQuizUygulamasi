...
class QuizActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonA.setOnClickListener(){
            doğruKontrol(binding.buttonA)
            soruSayacKontrol()
        }
        binding.buttonB.setOnClickListener(){
            doğruKontrol(binding.buttonB)
            soruSayacKontrol()
        }
        binding.buttonC.setOnClickListener(){
            doğruKontrol(binding.buttonC)
            soruSayacKontrol()
        }
        binding.buttonD.setOnClickListener(){
            doğruKontrol(binding.buttonD)
            soruSayacKontrol()
        }
    }
    ...
    fun soruYukle(){
        ...
        yanlisSecenekler= Bayraklardao().rastgele3YanlisSecenekGetir(veritabaniYardimcisi,dogruSoru.bayrak_id)
    ...
    fun doğruKontrol(button: Button){
